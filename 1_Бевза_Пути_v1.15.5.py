...
def main():
    ...
    try:
        ...
        elif code_1_value in ["Тобольск_образец_мужчина", "Тобольск_образец_женщина"]:
            new_values[3] = "U:\\ШАБЛОНЫ\\Заключения\\Тобольск"
        else:
        ...
        program_to_run = os.path.normpath(r'F:\Работа\1 EXPRESS SVO\cmd\2_Формирование_заключения_v1.54.py')
